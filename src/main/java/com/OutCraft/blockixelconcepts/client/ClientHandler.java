...
import com.OutCraft.blockixelconcepts.client.renderers.TumblewheedRenderer;
...
public class ClientHandler {
	...
	public static void registerEntityRenders(EntityRenderersEvent.RegisterRenderers event) {
		...
		event.registerEntityRenderer(EntityList.TUMBLEWHEED.get(), TumblewheedRenderer::new);
	}
	...
	public static void registerLayerDefinition(EntityRenderersEvent.RegisterLayerDefinitions event) {
		...
		event.registerLayerDefinition(TumblewheedModel.LAYER_LOCATION, TumblewheedModel::createBodyLayer);
	}
